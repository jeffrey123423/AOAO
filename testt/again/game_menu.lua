...
function scene:create( event )
    ...
    local bg = display.newImageRect( "background_Green_480x320.png", 560, 480 )
    local bg1 = display.newImageRect( "fire.png", 2500, 230 )
       bg.anchorX = 0
       bg.x = 0
       bg.y = centerY
       bg.speed = 0--新增速度
    ...
    Saturn.x=centerX*1.0
    Saturn.y=centerY*0.4
    Saturn.xScale = 0.8 --Ｘ軸縮放比例
    Saturn.yScale = 1.0 --Ｙ軸縮放比例
    Saturn:play()
    ...
    local starLight = display.newSprite( starLightSheet, { name="starLight", start=1, count=40, time=300 } )
    ...
    --標題Ｘ位置,Ｙ位置,內容
    title = titleFont:newBitmapString(centerX,0, "Under The Ground" )
